...
from .tools import handle_search, handle_download, handle_list_papers, handle_read_paper, handle_citation
from .tools import search_tool, download_tool, list_tool, read_tool, citation_tool
...
async def list_tools() -> List[types.Tool]:
    ...
    return [search_tool, download_tool, list_tool, read_tool, citation_tool]
...
async def call_tool(name: str, arguments: Dict[str, Any]) -> List[types.TextContent]:
    ...
    try:
        if name == "search_papers":
            ...
            return await handle_citation(arguments)
        else:
